...
exports.default = function (resource, api, fieldFactory, inputFactory) {
  var _resource$create = resource.create,
      ...
      remove = _resource$remove === undefined ? _adminOnRest.Delete : _resource$remove,
      _resource$show = resource.show,
      show = _resource$show === undefined ? _Show2.default : _resource$show;

  return _react2.default.createElement(_adminOnRest.Resource, (0, _extends3.default)({}, props, {
    create: create,
    edit: edit,
    key: name,
    list: list,
