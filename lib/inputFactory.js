...
import { BooleanInput, DateInput, NumberInput, ReferenceArrayInput, ReferenceInput, SelectArrayInput, SelectInput, TextInput } from 'admin-on-rest';
...
export default (function (field, options) {
  ...
  if (!props.validate && field.required) props.validate = function (value) {
